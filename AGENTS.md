...
├── supabase/
│   └── migrations/       # 0001..0055 — sequential SQL migrations
...
`notification_log`, `inbound_orphans`, `cron_checkpoints`, `workspace_deletions`. Messages Realtime
