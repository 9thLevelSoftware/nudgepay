...
Enabling workspace email also requires `RESEND_ALLOWED_FROM` (comma-separated verified From addresses). Enabling email fails closed if it is unset or empty.
