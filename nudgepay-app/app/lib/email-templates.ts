...
export const DEFAULT_EMAIL_TEMPLATES: EmailTemplate[] = [
  {
    ...
    body: "Hi {customer},\n\nThis is a friendly reminder that invoice {invoice} for {balance} was due {dueDate}. If you have already sent payment, thank you — please disregard this note. Otherwise, you can pay at {paymentLink} or call {phone}.\n\nThis mailbox is not monitored.\n\nThank you,\n{company}",
  },
  {
    id: "past-due",
    label: "Past due",
    subject: "Past due: invoice {invoice}",
    body: "Hi {customer},\n\nInvoice {invoice} for {balance} is now past due as of {dueDate}. Please pay at {paymentLink} or call {phone} if you need help arranging payment.\n\nThis mailbox is not monitored.\n\nThank you,\n{company}",
  },
  {
    id: "final-notice",
    label: "Final notice",
    subject: "Final notice: invoice {invoice}",
    body: "{customer},\n\nInvoice {invoice} for {balance} remains unpaid and is now seriously past due. Please pay at {paymentLink} or call {phone} promptly to arrange payment and avoid further action.\n\nThis mailbox is not monitored.\n\n{company}",
  },
  {
    id: "payment-received",
